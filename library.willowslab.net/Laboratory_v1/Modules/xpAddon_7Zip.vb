Module xpAddon_7Zip
    ...
    Public Function CreateZip(ByVal Target As String, ByVal File As String) As Boolean
        ...
        If xpFS.File_Exists(xpMabiCore.Dir_Myself_Assistant & "\" & xpMabiCore.Zip) = False Then

            If xpFS.File_Download(xpMabiCore.Zip7DownloadUrl, xpMabiCore.Dir_Myself_Assistant & "\" & xpMabiCore.Zip, True) = False Then
        ...
        Temp = "@echo off" & vbNewLine & "cd /D " & Chr(34) & xpMabiCore.Dir_Myself_Assistant & "" & Chr(34) & vbNewLine
        Temp &= "Call " & Chr(34) & xpMabiCore.Zip & Chr(34) & " a " & Chr(34) & File & Chr(34) & " " & Chr(34) & Target & "\*" & Chr(34) & " " & vbNewLine

        'Temp &= "pause" 'Debug

        xpFS.Text_Write(xpMabiCore.Dir_Myself_Temp & "\createzip.cmd", Temp, "Default")

        xpFS.ProgramOn(xpMabiCore.Dir_Myself_Temp & "\createzip.cmd", True)
        xpFS.File_Delete(xpMabiCore.Dir_Myself_Temp & "\createzip.cmd")
    ...
    Public Function UnZip(ByVal ZipFile As String, ByVal Target As String)
        ...
        Try
            ...
            MyProcess.StandardInput.Write("Call " & Chr(34) & xpMabiCore.Zip & Chr(34) & " x " & Chr(34) & ZipFile & Chr(34) & " -o" & Chr(34) & Target & Chr(34) & " -y" & Environment.NewLine)
