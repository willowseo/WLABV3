Module vxConfig
    ...
    Dim Option_Run_AutomaticCheck_PackServer As String = vxMabiCore.Dir_Myself_Option & "\Run_AutomaticCheck_PackServer.option"
    Dim Option_Run_PartUnPack_IncludeAddons As String = vxMabiCore.Dir_Myself_Option & "\Run_PartUnPack_IncludeAddons.option"

    ' 상태
    Dim State_ClientType As String = vxMabiCore.Dir_Myself_State & "\ClientType.state"
    Dim State_UpdateType As String = vxMabiCore.Dir_Myself_State & "\UpdateType.state"
    Dim State_UpdateHideDay As String = vxMabiCore.Dir_Myself_State & "\UpdateHideDay.state"
    Dim State_XmlViewer As String = vxMabiCore.Dir_Myself_State & "\XmlViewer.state"


    Public Function get_State_ClientType() As String

        Return vxFS.Read_File(State_ClientType, "", "Mabinogi")

    End Function

    Public Function get_State_UpdateHideDay() As String

        Return vxFS.Read_File(State_UpdateHideDay)

    End Function

    Public Function get_State_UpdateType() As String

        Return vxFS.Read_File(State_UpdateType, "", "Latest")

    End Function

    Public Function get_State_XmlViewer() As String

        Return vxFS.Read_File(State_XmlViewer, "", "notepad.exe")

    End Function

    Public Sub set_State_ClientType(ByVal Value As String)

        vxFS.Text_Write(State_ClientType, Value)
        vxMabiCore.State_ClientType = Value

    End Sub

    Public Sub set_State_UpdateType(ByVal Value As String)

        vxFS.Text_Write(State_UpdateType, Value)
        vxMabiCore.State_UpdateType = Value

    End Sub

    Public Sub set_State_UpdateHideDay(ByVal Value As String)

        vxFS.Text_Write(State_UpdateHideDay, Value)

    End Sub

    Public Sub set_State_XmlViewer(ByVal Value As String)

        vxFS.Text_Write(State_XmlViewer, Value)
    ...
    Public Sub set_Option_Run_PartUnPack(ByVal MakeFile As Boolean)
        ...
        If MakeFile = True Then
            ...
            vxFS.Text_Write(Option_Run_PartUnPack, "")

        Else

            vxFS.File_Delete(Option_Run_PartUnPack)
    ...
    Public Sub set_Option_Run_PartUnPack_IncludeAddons(ByVal MakeFile As Boolean)
        ...
        If MakeFile = True Then
            ...
            vxFS.Text_Write(Option_Run_PartUnPack_IncludeAddons, "")

        Else

            vxFS.File_Delete(Option_Run_PartUnPack_IncludeAddons)
    ...
    Public Sub set_Option_Run_AutomaticCheck_PackServer(ByVal MakeFile As Boolean)
        ...
        If MakeFile = True Then
            ...
            vxFS.Text_Write(Option_Run_AutomaticCheck_PackServer, "")

        Else

            vxFS.File_Delete(Option_Run_AutomaticCheck_PackServer)
