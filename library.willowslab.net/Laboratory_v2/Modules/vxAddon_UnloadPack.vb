Module vxAddon_UnloadPack
    ...
    Public Sub Run_UnloadPack(ByVal Mode As String)
        ...
        If Mode = "cm" Then
            MyProcess.StandardInput.Write("Call " & Chr(34) & vxMabiCore.UnloadPackage & Chr(34) & " c" & Environment.NewLine)
            MyProcess.StandardInput.Write("Call " & Chr(34) & vxMabiCore.UnloadPackage & Chr(34) & " m" & Environment.NewLine)
        Else
            MyProcess.StandardInput.Write("Call " & Chr(34) & vxMabiCore.UnloadPackage & Chr(34) & " " & Mode & Environment.NewLine)
        End If
    ...
    Public Sub Add_FileList(ByVal Files As List(Of String))
        ...
        vxFS.Text_Write(vxMabiCore.Dir_Myself_Assistant & "\file_list.txt", Trim(Replace(Data, vxMabiCore.Dir_Mabinogi & "\data\", "")), "Default")
    ...
    Public Sub Add_MabiPackList(ByVal Data As String)
        ...
        vxFS.Text_Write(vxMabiCore.Dir_Myself_Assistant & "\pack_list.txt", Trim(Data), "Default")
    ...
    Public Function getPackagesToList(ByVal vType As PackageType) As List(Of String)
        ...
        Dim Target As String = vxMabiCore.Dir_Mabinogi & "\package"
        ...
        If My.Computer.FileSystem.DirectoryExists(Target) = True Then
            ...
            For Each vPack As String In vxFS.getFiles(Target, vxFS.GetFilesType.FindExtension, ".pack")
    ...
    Public Sub RemoveFileListByPack()
        ...
        If My.Computer.FileSystem.DirectoryExists(Target) = True Then
            ...
            ' uph 파일 지우고
            For Each vFile As String In vxFS.getFiles(Target, vxFS.Getfilestype.FindExtension, ".uph")
                vxFS.File_Delete(vFile)
            Next
    ...
    Public Sub RemoveFileIndexByPack()
        ...
        If My.Computer.FileSystem.DirectoryExists(Target) = True Then
            ...
            ' uph 파일 지우고
            For Each vFile As String In vxFS.getFiles(Target, vxFS.Getfilestype.FindExtension, ".uidx")
                vxFS.File_Delete(vFile)
            Next
    ...
    Public Sub Run_MabiPackageClear()
        ...
        If vxConfig.is_Option_Run_PartUnPack_IncludeAddons() = True Then
